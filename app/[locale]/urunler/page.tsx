      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative overflow-hidden bg-[#0d2d5e] pt-28 md:pt-36 pb-20 md:pb-28">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Ürünlerimizi <span className="text-[#00b4c8]">Keşfedin</span>
            </motion.h1>
            ...
            >
              Bebek bezinden yetişkin hijyen ürünlerine, ıslak mendilden yüzey temizleme havlusuna kadar
              geniş ürün yelpazemiz ile uluslararası kalite standartlarında üretim yapıyoruz.
            </motion.p>
            ...
            >
              {[
                { val: '9', label: 'Ürün Kategorisi' },
                { val: '45+', label: 'Ürün Çeşidi' },
                { val: 'ISO', label: 'Sertifikalı Üretim' },
              ].map(({ val, label }) => (
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          >
            ...
            <p className="text-gray-500 max-w-lg mx-auto">
              İhtiyacınıza uygun kategoriyi seçerek ürünlerimizi inceleyin.
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <h2
                ...
                style={{ fontFamily: 'var(--font-outfit)' }}
              >
                Toptan Sipariş veya Özel Etiket mi?
              </h2>
              <p className="text-blue-200/70 mb-8 max-w-lg mx-auto">
                Ürünlerimiz hakkında detaylı bilgi almak veya toptan fiyat teklifi
